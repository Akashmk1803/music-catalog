...
export function TopNavbar({ onMenuClick }: TopNavbarProps) {
  ...
  return (
    <header className="fixed top-0 left-0 lg:left-[240px] right-0 h-20 bg-background/40 backdrop-blur-xl z-30 flex items-center justify-between px-md lg:px-margin border-b border-outline-variant/5 border-t border-primary/20 transition-all duration-300">
