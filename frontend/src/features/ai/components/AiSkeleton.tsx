  ...
  return (
    <div className="flex flex-col w-full pb-xxl animate-pulse">
      ...
      <section className="relative w-full mb-xxl">
        <div className="relative bg-surface-container-low/40 rounded-xl p-xl lg:p-xxl border-t border-white/5 h-[300px]">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg mb-xxl">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-surface-container-high/30 p-lg rounded-xl border-t border-white/5 h-[160px] flex flex-col justify-between">
