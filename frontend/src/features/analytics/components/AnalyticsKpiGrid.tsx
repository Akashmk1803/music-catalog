...
export function AnalyticsKpiGrid({ overview, favoriteGenre }: AnalyticsKpiGridProps) {
  ...
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {/* Total Songs */}
      <div className="bg-surface-container-low/40 backdrop-blur-md p-8 rounded-xl border border-white/5 flex flex-col gap-6 hover:bg-surface-container-high/40 hover:-translate-y-1 hover:shadow-xl transition-all duration-300">
