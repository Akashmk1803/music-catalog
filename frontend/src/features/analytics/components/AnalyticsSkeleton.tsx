  ...
  return (
    <div className="flex flex-col w-full gap-xxl pb-xxl animate-pulse">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-gutter">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="bg-surface-container-low/40 p-xl border-t border-white/5 h-[140px] rounded-sm">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        <div className="lg:col-span-7 bg-surface-container/30 p-xl h-[350px] rounded-sm"></div>
        <div className="lg:col-span-5 bg-surface-container/30 p-xl h-[350px] rounded-sm"></div>
      </section>
      
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        <div className="lg:col-span-8 bg-surface-container/30 p-xl h-[400px] rounded-sm"></div>
        <div className="lg:col-span-4 flex flex-col gap-gutter">
          <div className="bg-surface-container/30 p-xl h-[180px] rounded-sm"></div>
          <div className="bg-surface-container/30 p-xl h-[180px] rounded-sm"></div>
        </div>
      </section>
    </div>
